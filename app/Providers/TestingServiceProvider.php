...
class TestingServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        AssertableInertia::macro('hasPaginateResource', function (string $key, ResourceCollection $resource) {
        ...
        TestResponse::macro('assertHasPaginateResource', function (string $key, ResourceCollection $resource) {
            return $this->assertInertia(fn(AssertableInertia $inertia) => $inertia->hasPaginateResource($key, $resource));
        });
    }
}
